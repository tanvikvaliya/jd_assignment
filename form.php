                ...
                <div class="details personal">
                    ...
                    <div class="fields">
                        <div class="input-field">
                            ...
                            <input type="text" name="name" id="name" value="<?php echo isset($row['name']) ? $row['name'] : ''; ?>" placeholder="Enter your name">
                            <div class="invalid-feedback" id="name-err"></div>
                        </div>

                        <div class="input-field">
                            <label>Email</label>
                            <input type="text" name="email" id="email"  value="<?php echo isset($row['email']) ? $row['email'] : ''; ?>" placeholder="Enter your email">
                        ...
                        <div class="input-field">
                            <label>Address</label>
                            <input type="text" name="address" id="address" value="<?php echo isset($row['address']) ? $row['address'] : ''; ?>" placeholder="Enter your address">
                            <div class="invalid-feedback" id="address-err"></div>
                        </div>

                        <div class="input-field">
                            <label>Mobile Number</label>
                            <input type="number" name="mobile" id="mobile" value="<?php echo isset($row['mobile']) ? $row['mobile'] : ''; ?>" placeholder="Enter mobile number">
                            <div class="invalid-feedback" id="mobile-err"></div>

                        </div>

                        <div class="input-field">
                            <label>City</label>
                            <input type="text" name="city" id="city" value="<?php echo isset($row['city']) ? $row['city'] : ''; ?>" placeholder="Enter your City">
                        ...
                        <div class="input-field">
                            ...
                            <div class="invalid-feedback" id="country-err"></div>
                        </div>
                    </div>
                    <button type="submit" id="sbt-btn">Submit</button>
                </div> 
            </div>
        </form> -->
        <div class="card mt-4">
